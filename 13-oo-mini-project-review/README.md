...
* Review Object Oriented Relationships by solving the OO Mini Project lab.
* See how it relates to Active Record by converting it to use Active Record.
